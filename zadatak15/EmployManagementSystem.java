...
class Employee_Add
{
    public void createFile()
    {
        ...
        emp.getInfo();
        try{
            File f1=new File("file"+emp.oib+".txt");
            if(f1.createNewFile()){
                FileWriter myWriter = new FileWriter("EmployeeDataList1.txt");
                myWriter.write("Employee ID:"+emp.oib+"\n"+"Employee Name:"+emp.name+"\n"+
                "Last Name:"+emp.last_name+"\n"+"Employee Workplace:"+emp.workplace+"\n");
                myWriter.close();
...
class EmployDetail
{
    ...
    public void getInfo()
    {
        ...
        System.out.print("Enter Employee's Workplace: ");
        workplace=sc.nextLine();
        System.out.print("Enter Employee's OIB: ");
        oib=sc.nextLine();
